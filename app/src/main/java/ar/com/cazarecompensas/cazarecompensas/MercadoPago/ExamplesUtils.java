package ar.com.cazarecompensas.cazarecompensas.MercadoPago;
...
import ar.com.cazarecompensas.cazarecompensas.MercadoPago.CardActivity;
import retrofit2.Response;

/**
 * Created by Laucha on 05/11/2017.
 */
...
public class ExamplesUtils {
    ...
    public static void createPayment(final Activity activity, String token, Integer installments, Long cardIssuerId, final PaymentMethod paymentMethod, Discount discount) {
        ...
        if (paymentMethod != null) {
            ...
            MerchantPayment payment = new MerchantPayment(item, installments, cardIssuerId, token, paymentMethodId, campaignId, DUMMY_MERCHANT_ACCESS_TOKEN);
